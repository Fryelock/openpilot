...
class CAR:
  ...
  CROSSTREK_2020 = "SUBARU CROSSTREK SPORT 2020"
...
=======
>>>>>>> Fix test_car_models, add underscore to model year
  CAR.CROSSTREK_2020: [
  # CROSSTREK SPORT 2020 (CANADA) (scullionw/1will)
  {
...
DBC = {
  ...
  CAR.CROSSTREK_2020: dbc_dict('subaru_global_2017', None),
}

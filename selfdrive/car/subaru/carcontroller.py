...
class CarController():
  ...
  def update(self, enabled, CS, frame, actuators, pcm_cancel_cmd, visual_alert, left_line, right_line):
    ...
    # button control
    if CS.CP.carFingerprint in [CAR.FORESTER_2017, CAR.LEGACY_2015, CAR.OUTBACK_2015, CAR.OUTBACK_2019]:
    ...
    if CS.CP.carFingerprint in [CAR.ASCENT, CAR.FORESTER, CAR.IMPREZA]:

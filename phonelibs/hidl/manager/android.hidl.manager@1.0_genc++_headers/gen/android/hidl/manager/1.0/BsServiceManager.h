...
struct BsServiceManager : IServiceManager, ::android::hardware::details::HidlInstrumentor {
    ...
    ::android::hardware::Return<bool> add(const ::android::hardware::hidl_string& name, const ::android::sp<::android::hidl::base::V1_0::IBase>& service) {
        ...
        if (service != nullptr && !service->isRemote()) {
            _hidl_wrapped_service = ::android::hidl::base::V1_0::IBase::castFrom(::android::hardware::details::wrapPassthrough<::android::hidl::base::V1_0::IBase>(service));
    ...
    ::android::hardware::Return<IServiceManager::Transport> getTransport(const ::android::hardware::hidl_string& fqName, const ::android::hardware::hidl_string& name) {
        ...
        #ifdef __ANDROID_DEBUGGABLE__
        IServiceManager::Transport _hidl_out_transport = _hidl_return;
        #endif // __ANDROID_DEBUGGABLE__
        atrace_end(ATRACE_TAG_HAL);
        #ifdef __ANDROID_DEBUGGABLE__
        if (UNLIKELY(mEnableInstrumentation)) {
    ...
    ::android::hardware::Return<bool> registerForNotifications(const ::android::hardware::hidl_string& fqName, const ::android::hardware::hidl_string& name, const ::android::sp<IServiceNotification>& callback) {
        ...
        ::android::sp<IServiceNotification> _hidl_wrapped_callback;
        if (callback != nullptr && !callback->isRemote()) {
            _hidl_wrapped_callback = IServiceNotification::castFrom(::android::hardware::details::wrapPassthrough<IServiceNotification>(callback));

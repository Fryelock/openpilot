...
struct IServiceNotification : public ::android::hidl::base::V1_0::IBase {
    ...
    static ::android::hardware::Return<::android::sp<IServiceNotification>> castFrom(const ::android::sp<IServiceNotification>& parent, bool emitError = false);
    static ::android::hardware::Return<::android::sp<IServiceNotification>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);

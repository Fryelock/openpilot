...
struct IComposerCallback : public ::android::hidl::base::V1_0::IBase {
    ...
    // @callflow(next="*")
    virtual ::android::hardware::Return<void> onHotplug(uint64_t display, IComposerCallback::Connection connected) = 0;
    ...
    static ::android::hardware::Return<::android::sp<IComposerCallback>> castFrom(const ::android::sp<IComposerCallback>& parent, bool emitError = false);
    static ::android::hardware::Return<::android::sp<IComposerCallback>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
constexpr int32_t operator|(const IComposerCallback::Connection lhs, const IComposerCallback::Connection rhs) {
    return static_cast<int32_t>(static_cast<int32_t>(lhs) | static_cast<int32_t>(rhs));
}

constexpr int32_t operator|(const int32_t lhs, const IComposerCallback::Connection rhs) {
    return static_cast<int32_t>(lhs | static_cast<int32_t>(rhs));
}

constexpr int32_t operator|(const IComposerCallback::Connection lhs, const int32_t rhs) {
...
constexpr int32_t &operator|=(int32_t& v, const IComposerCallback::Connection e) {
...
std::string toString(const ::android::sp<IComposerCallback>&);

...
struct BpHwComposerClient : public ::android::hardware::BpInterface<IComposerClient>, public ::android::hardware::details::HidlInstrumentor {
    ...
    static ::android::hardware::Return<void>  _hidl_registerCallback(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::sp<IComposerCallback>& callback);
    ...
    static ::android::hardware::Return<Error>  _hidl_destroyVirtualDisplay(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, uint64_t display);
    ...
    static ::android::hardware::Return<Error>  _hidl_destroyLayer(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, uint64_t display, uint64_t layer);
    ...
    static ::android::hardware::Return<Error>  _hidl_getClientTargetSupport(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, uint64_t display, uint32_t width, uint32_t height, ::android::hardware::graphics::common::V1_0::PixelFormat format, ::android::hardware::graphics::common::V1_0::Dataspace dataspace);
    ...
    static ::android::hardware::Return<void>  _hidl_getDisplayAttribute(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, uint64_t display, uint32_t config, IComposerClient::Attribute attribute, getDisplayAttribute_cb _hidl_cb);
    ...
    static ::android::hardware::Return<Error>  _hidl_setClientTargetSlotCount(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, uint64_t display, uint32_t clientTargetSlotCount);
    static ::android::hardware::Return<Error>  _hidl_setActiveConfig(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, uint64_t display, uint32_t config);
    static ::android::hardware::Return<Error>  _hidl_setColorMode(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, uint64_t display, ::android::hardware::graphics::common::V1_0::ColorMode mode);
    static ::android::hardware::Return<Error>  _hidl_setPowerMode(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, uint64_t display, IComposerClient::PowerMode mode);
    static ::android::hardware::Return<Error>  _hidl_setVsyncEnabled(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, uint64_t display, IComposerClient::Vsync enabled);
    static ::android::hardware::Return<Error>  _hidl_setInputCommandQueue(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::MQDescriptorSync<uint32_t>& descriptor);
    ...
    // Methods from IComposerClient follow.
    ::android::hardware::Return<void> registerCallback(const ::android::sp<IComposerCallback>& callback) override;
    ...
    ::android::hardware::Return<Error> destroyVirtualDisplay(uint64_t display) override;
    ::android::hardware::Return<void> createLayer(uint64_t display, uint32_t bufferSlotCount, createLayer_cb _hidl_cb) override;
    ::android::hardware::Return<Error> destroyLayer(uint64_t display, uint64_t layer) override;
    ::android::hardware::Return<void> getActiveConfig(uint64_t display, getActiveConfig_cb _hidl_cb) override;
    ::android::hardware::Return<Error> getClientTargetSupport(uint64_t display, uint32_t width, uint32_t height, ::android::hardware::graphics::common::V1_0::PixelFormat format, ::android::hardware::graphics::common::V1_0::Dataspace dataspace) override;
    ::android::hardware::Return<void> getColorModes(uint64_t display, getColorModes_cb _hidl_cb) override;
    ::android::hardware::Return<void> getDisplayAttribute(uint64_t display, uint32_t config, IComposerClient::Attribute attribute, getDisplayAttribute_cb _hidl_cb) override;
    ...
    ::android::hardware::Return<Error> setClientTargetSlotCount(uint64_t display, uint32_t clientTargetSlotCount) override;
    ::android::hardware::Return<Error> setActiveConfig(uint64_t display, uint32_t config) override;
    ::android::hardware::Return<Error> setColorMode(uint64_t display, ::android::hardware::graphics::common::V1_0::ColorMode mode) override;
    ::android::hardware::Return<Error> setPowerMode(uint64_t display, IComposerClient::PowerMode mode) override;
    ::android::hardware::Return<Error> setVsyncEnabled(uint64_t display, IComposerClient::Vsync enabled) override;
    ::android::hardware::Return<Error> setInputCommandQueue(const ::android::hardware::MQDescriptorSync<uint32_t>& descriptor) override;

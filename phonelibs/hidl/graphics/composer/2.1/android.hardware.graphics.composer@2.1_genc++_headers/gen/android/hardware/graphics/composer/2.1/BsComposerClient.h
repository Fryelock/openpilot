...
struct BsComposerClient : IComposerClient, ::android::hardware::details::HidlInstrumentor {
    ...
    ::android::hardware::Return<void> registerCallback(const ::android::sp<IComposerCallback>& callback) {
        ...
        ::android::sp<IComposerCallback> _hidl_wrapped_callback;
        if (callback != nullptr && !callback->isRemote()) {
            _hidl_wrapped_callback = IComposerCallback::castFrom(::android::hardware::details::wrapPassthrough<IComposerCallback>(callback));
    ...
    ::android::hardware::Return<Error> destroyVirtualDisplay(uint64_t display) {
        ...
        #ifdef __ANDROID_DEBUGGABLE__
        Error _hidl_out_error = _hidl_return;
        #endif // __ANDROID_DEBUGGABLE__
        atrace_end(ATRACE_TAG_HAL);
        #ifdef __ANDROID_DEBUGGABLE__
        if (UNLIKELY(mEnableInstrumentation)) {
    ...
    ::android::hardware::Return<Error> destroyLayer(uint64_t display, uint64_t layer) {
    ...
    ::android::hardware::Return<Error> getClientTargetSupport(uint64_t display, uint32_t width, uint32_t height, ::android::hardware::graphics::common::V1_0::PixelFormat format, ::android::hardware::graphics::common::V1_0::Dataspace dataspace) {
    ...
    ::android::hardware::Return<void> getDisplayAttribute(uint64_t display, uint32_t config, IComposerClient::Attribute attribute, getDisplayAttribute_cb _hidl_cb) {
        if (_hidl_cb == nullptr) {
            return ::android::hardware::Status::fromExceptionCode(
                    ::android::hardware::Status::EX_ILLEGAL_ARGUMENT,
                    "Null synchronous callback passed.");
    ...
    ::android::hardware::Return<Error> setClientTargetSlotCount(uint64_t display, uint32_t clientTargetSlotCount) {
    ...
    ::android::hardware::Return<Error> setActiveConfig(uint64_t display, uint32_t config) {
    ...
    ::android::hardware::Return<Error> setColorMode(uint64_t display, ::android::hardware::graphics::common::V1_0::ColorMode mode) {
    ...
    ::android::hardware::Return<Error> setPowerMode(uint64_t display, IComposerClient::PowerMode mode) {
    ...
    ::android::hardware::Return<Error> setVsyncEnabled(uint64_t display, IComposerClient::Vsync enabled) {
    ...
    ::android::hardware::Return<Error> setInputCommandQueue(const ::android::hardware::MQDescriptorSync<uint32_t>& descriptor) {

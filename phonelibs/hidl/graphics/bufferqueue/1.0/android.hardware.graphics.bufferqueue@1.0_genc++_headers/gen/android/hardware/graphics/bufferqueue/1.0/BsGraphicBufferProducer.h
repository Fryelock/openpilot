...
struct BsGraphicBufferProducer : IGraphicBufferProducer, ::android::hardware::details::HidlInstrumentor {
    ...
    ::android::hardware::Return<void> queueBuffer(int32_t slot, const IGraphicBufferProducer::QueueBufferInput& input, queueBuffer_cb _hidl_cb) {
        if (_hidl_cb == nullptr) {
            return ::android::hardware::Status::fromExceptionCode(
                    ::android::hardware::Status::EX_ILLEGAL_ARGUMENT,
                    "Null synchronous callback passed.");
    ...
    ::android::hardware::Return<void> connect(const ::android::sp<IProducerListener>& listener, int32_t api, bool producerControlledByApp, connect_cb _hidl_cb) {
        if (_hidl_cb == nullptr) {
            return ::android::hardware::Status::fromExceptionCode(
                    ::android::hardware::Status::EX_ILLEGAL_ARGUMENT,
                    "Null synchronous callback passed.");
        ...
        ::android::sp<IProducerListener> _hidl_wrapped_listener;
        if (listener != nullptr && !listener->isRemote()) {
            _hidl_wrapped_listener = IProducerListener::castFrom(::android::hardware::details::wrapPassthrough<IProducerListener>(listener));
    ...
    ::android::hardware::Return<int32_t> disconnect(int32_t api, IGraphicBufferProducer::DisconnectMode mode) {

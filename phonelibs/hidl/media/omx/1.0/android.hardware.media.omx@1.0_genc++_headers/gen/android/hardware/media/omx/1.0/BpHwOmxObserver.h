...
struct BpHwOmxObserver : public ::android::hardware::BpInterface<IOmxObserver>, public ::android::hardware::details::HidlInstrumentor {
    ...
    static ::android::hardware::Return<void>  _hidl_onMessages(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::hidl_vec<Message>& messages);

    // Methods from IOmxObserver follow.
    ::android::hardware::Return<void> onMessages(const ::android::hardware::hidl_vec<Message>& messages) override;

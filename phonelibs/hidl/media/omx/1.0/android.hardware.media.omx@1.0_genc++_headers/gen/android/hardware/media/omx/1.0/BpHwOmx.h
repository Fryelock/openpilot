...
struct BpHwOmx : public ::android::hardware::BpInterface<IOmx>, public ::android::hardware::details::HidlInstrumentor {
    ...
    static ::android::hardware::Return<void>  _hidl_allocateNode(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::hidl_string& name, const ::android::sp<IOmxObserver>& observer, allocateNode_cb _hidl_cb);
    ...
    ::android::hardware::Return<void> allocateNode(const ::android::hardware::hidl_string& name, const ::android::sp<IOmxObserver>& observer, allocateNode_cb _hidl_cb) override;
